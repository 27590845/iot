...
function getClassification(tag) {
	let base_static_url = baseurl + "/static";
	// 记录网站分类及相关信息
	let website_path = {
		"index": {
			"index": {
				"name": "首页",
				"url": base_static_url+"/html/index/index.html"
			},
		},
		"data_center": {
			"index": {
				"name": "数据中心",
				"url": base_static_url+"/html/data_center/index.html"
			},
			"scenelist": {
				"name": "场景列表",
				"url": base_static_url+"/html/data_center/scenelist.html"
			},
			"search": {
				"name": "搜索结果",
				"url": base_static_url+"/html/data_center/scenelist.html"
			...
			"sceneadd": {
				"name": "添加场景",
				"url": base_static_url+"/html/data_center/sceneadd.html"
			},
			"sceneinfo": {
				"name": "场景信息",
				"url": base_static_url+"/html/data_center/sceneinfo.html"
			},
			"sceneupdate": {
				"name": "更新场景",
				"url": base_static_url+"/html/data_center/sceneupdate.html"
			},
			"nodeadd": {
				"name": "新增节点",
				"url": base_static_url+"/html/data_center/nodeadd.html"
			},
			"nodeinfo": {
				"name": "节点信息",
				"url": base_static_url+"/html/data_center/nodeinfo.html"
			},
			"nodeupdate": {
				"name": "更新节点",
				"url": base_static_url+"/html/data_center/nodeupdate.html"
			}
		}
	}
