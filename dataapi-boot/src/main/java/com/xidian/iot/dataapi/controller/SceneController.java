...
public class SceneController {
    ...
    @ApiOperation(value = "根据identifier网关身份标示查询scene")
    @GetMapping("/search/{identifier}")
    public HttpResult searchByIdentifier(@ApiParam(name = "identifier", value = "网关身份标示") @PathVariable("identifier") String identifier) {
